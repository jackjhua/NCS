...
contract NucleusDaoDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
...
contract NucleusDao is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    NucleusDaoDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        address[4] memory addrs, // reward, router, dao, lucky
        ...
        name_ = "Nucleus DAO";
        symbol_ = "NCS";
        _mint(owner(), 100000000000 * 10**18);// _mint(owner(), totalSupply);
        rewardToken = addrs[0];
        ...
        dividendTracker = NucleusDaoDividendTracker(
